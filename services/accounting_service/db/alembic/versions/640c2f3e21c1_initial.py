...
Revision ID: 640c2f3e21c1
Revises: 
Create Date: 2024-03-10 16:28:26.838615
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('ENROLL', 'WITHDRAW', 'PAYMENT', name='type'), nullable=False),
